 ...
 */
function isKitErrorFile(basename) {
    return basename.slice(0, -path__default.extname(basename).length) === '+error';
}
/**
...
function throwIfTypeScript7() {
    ...
    if (major >= 7) {
        throw new Error(`emitDts is not compatible with TypeScript ${ts.version}. Please use a TypeScript version lower than 7.x.`);
    }
}
